...
<head>
  ...
  <title>CCP | Resumen Rol del VIN</title>
				...
				<div class="col-sm-12">
					<div class="mt-1 mb-3 p-3 button-container fondo-container">
						...
						<ol class="breadcrumb fondo-encabezados">
							...
							<li>
								<a class="text-white" href="catalogo_rol_vin_agregar.php">Agregar Tipo Rol del VIN</b></a>
							</li>
							<span class="text-white"> &nbsp;/&nbsp; </span>
							<li  class="active text-white">
								<strong>Resumen Rol del VIN</strong>
							</li>
						</ol>
								...
								<table width="100%" class="table table-striped table-bordered table-hover panel-body-center-table" id="table_departemento_id">
									...
									<tbody>  
										...
										while ($row_rol_vin = mysql_fetch_array($result_rol_vin)) {
											...
											$row_funciones = explode("|", $row_rol_vin[columna_a]);
											
											if (count($row_funciones) <= 1) {

												$incrementar ++;
												echo "
												<tr>
												<td>$incrementar</td>
												<td>$row_rol_vin[nombre]</td>
												<td>$name_funcion</td>
												<td><input type='checkbox' name='id_orden_departamento[]' class='filtros' value='$row_rol_vin[idorden_logistica_departamento_id]' >
												</td>
												</tr>
												";
											}else{

												foreach ($row_funciones as $key_funcion => $name_funcion) {

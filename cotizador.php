									...
									<div class="row">
										...
										<div class=" col-sm-8">
											<label>Rendimiento: <span><a href="https://www.gob.mx/conuee/documentos/rendimiento-de-combustible-en-vehiculos-ligeros-de-venta-en-mexico"  target="_blank" title="Consulta rendimientos"><i class="fas fa-external-link-alt"></i></a>&nbsp; &nbsp; &nbsp;</span> </label> 
																...
																<input type="radio" class="modNo radio1" name="mod"   required="">  
...
<!--------------------------------------------->
					...
					directionsService.route({
						...
						if (status === 'OK') {
							...
							for (var i = 0; i < route.legs.length; i++) {
								...
								km2=parseFloat(route.legs[i].distance.value/1000);
								dur = route.legs[i].duration.text;
								dur2 =route.legs[i].duration.value;
								kml=unidad_rendimiento;
								vel=(km2/(dur2/3600)).toFixed(0);
								gas=(km2/kml).toFixed(2);
								cost=((document.getElementById("precio_gas").value)*gas).toFixed(2);
	...
	<!---<script src="generar_logistica.js"></script>--->
		<script src="agrega_auto.js"></script>

...
<head>
	...
	<title>CCP | Agregar Búsqueda Departamento ID</title>
				...
				<div class="col-sm-12">
					<div class="mt-1 mb-3 p-3 button-container fondo-container">
						...
						<ol class="breadcrumb fondo-encabezados">
							...
							<li>
								<a class="text-white" href="catalogo_departamento_busqueda_id.php">Resumen Búsqueda Departamento ID</a>
							</li>
							<span class="text-white"> &nbsp;/&nbsp; </span>
							<li class="text-white" class="active">
								<strong> Agregar Búsqueda Departamento ID</strong>
							</li>
						</ol>
						...
						<form id="form_balance" method="POST" action="guardar_tipo_orden.php">
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group row">
										...
										<div id="button_principal_orden" class="col-sm-12" >
											<center>
												<a id='create_departamento_id' style='width: 180px;height: 90px;' class="create_departamento_id icon-DOrden" class="" title="Add field"><i class='fa fa-plus-circle fa-5x zoom font-iconr' aria-hidden='true' ></i></a>
												<div class="tooltipDetalleOrden mb-3">
													<p>Agregar Búsqueda Departamento ID</p>
												</div>
											</center>
										...
										<input type="hidden" name="contador_departamento_id" value="0" required="" class="contador_departamento_id">
										...
										<script type="text/javascript">
											$(document).ready(function(){
												...
												var addButtonVIN = $('#create_departamento_id');
												...
												$(addButtonVIN).click(function(){ 
													...
													<option value='Proveedor Info'>Proveedor Info</option>
													</select>
													...
													$(".contador_departamento_id").val(valor_vin);



													if (valor_vin == 0) {
														$(".contador_departamento_id").val("0");

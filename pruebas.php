					...
					<div class="col-sm-12">
						...
						<div class="mt-1 mb-3 p-3 button-container fondo-container">
							...
							<ol class="breadcrumb fondo-encabezados">
								...
								<li>
									<a href="agregar_orden_logistica.php" class="text-white">Agregar Nueva Orden</a>
								</li>
								<span class="text-white"> &nbsp;/&nbsp; </span>
							...
							<div class="col-sm-12" id="search_vehicle"  > 
								<a  id="origen"></a>
								<h3 class="mt-4 m-b" style="font-size: 20px; border-bottom: 2px solid #882439; color: #d43759;"><strong>Vehículo(s) </strong><label id="ponAuto" style="font-size: 20px; border-bottom: 2px solid #882439; color: #d43759;">0</label></h3>
								...
								<div class="container-bg-1 p-3">
									<div class="row">
										...
										<div class=" col-sm-8">
											<label>Rendimiento: <span><a href="https://www.gob.mx/conuee/documentos/rendimiento-de-combustible-en-vehiculos-ligeros-de-venta-en-mexico"  target="_blank" title="Consulta rendimientos"><i class="fas fa-external-link-alt"></i></a>&nbsp; &nbsp; &nbsp;</span> </label> 
																<label>¿Modificar? </label>
																<label for="modSi">SI</label>
																<input type="radio" class="modSi radio1" name="mod"   required="">
																<label for="modSi">NO</label>
																<input type="radio" class="modNo radio1" name="mod"  checked required="">  
										...
										<a class="button-eliminar mt-4 mb-4" id="show_ruta" href='#puntos' onclick="habilitaRuta()" style="display: none">
	                                    	<span class="background-green">Sigue Ruta</span><i class="fas fa-arrow-right background-green-f"></i>
	                                	</a> 										
									</div>								
								</div>
...
<!-------->
								<div class="col-sm-12" id="show_rol_vin_adicional" >
													...
													<div class="col-sm-12 mt-4" id="aniade" style="display:none">
														<center>
															<a id='agrega_v' style='width: 180px;height: 90px;' class="agrega_v icon-DOrden" title="Agregar auto"><i class='fa fa-plus-circle fa-5x zoom font-iconr' aria-hidden='true' ></i></a>
													...
													<div class="col-sm-12 tabla_llenar" id="show_vin_adicional">

													</div>

											<input id="aux_vin" type="hidden" value="0" readonly>
											<input id="count_vin" type="hidden" value="0" readonly>
											<input id="num_autos" type="hidden" value="0" readonly>
...
<!----->
							...
							<div class="col-sm-12 mt-4 mb-4" id="button_origen_destino" style="display: none;">
								...
								<div class="col-sm-12 p-0">
									<center>
										<input type="button" class="btn btn-lg btn-primary" id="Prueba" value="Prueba" onclick="CalculaRegresos(); ">
										<input type="button" class="btn btn-lg btn-primary" id="sencilla" value="Ruta Sencilla" onclick="validarRuta(1); ">
										<input type="button" class="btn btn-lg btn-primary" id="redonda" value="Ruta Redonda" onclick="validarRuta(2); ">
										<input type="button" class="btn btn-lg btn-primary" id="parada" value="Agrega Parada" onclick="AgregaParada();">
						...
						<div id="ruta">
							...
							<div class="col-sm-12 mt-4 mb-4" id="show_datos_recorrido" style="display: none;">								
								<div class="col-sm-12 container-bg-1 p-3">
									...
									<div class="row ">
											<div class="col-sm-2"><label>Vehiculos:</label></div>
											<select id="autosRuta" name="autosRuta" class="col-sm-6 form-control ">
											</select>

									</div>	
									<br>
									<div class="row">
										<div class="col-sm-2"><label>Distancia:</label></div>
										<div class="col-sm-2"><label>Tiempo Estimado  			 </label></div>
										<div class="col-sm-2"><label>Rendimiento del Vehiculo: 	</label></div>
										<div class="col-sm-2"><label>Litros Estimados:   			</label></div>
										<div class="col-sm-2"><label>Costo Total:   				</label></div>
										<div class="col-sm-2"><label>Velocidad Constante Sugerida:</label></div>
									</div>	
									<div class="row">
										<div class="col-sm-2"><input type="text" class="form-control" name="kilometros" id="kilometros" readonly="" ></div>
										<div class="col-sm-2"><input type="text" class="form-control" name="timeall" id="timeall" readonly="" ></div>
										<div class="col-sm-2"><input type="text" class="form-control" name="kml" id="kml" readonly="" ></div>
										<div class="col-sm-2"><input type="text" class="form-control" name="gas" id="gas" readonly="" ></div>
										<div class="col-sm-2"><input type="text" class="form-control" name="costo" id="costo" readonly="" ></div>
										<div class="col-sm-2"><input type="text" class="form-control" name="velocidad" id="velocidad" readonly="" ></div>
									</div>
								</div>
							</div>
...
<!--------------------------------------------->
							...
							<div  class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
								<hr>
								<div class="feed-single mb-3"> <div id="right-panel">
	...
	<!---<script src="generar_logistica.js"></script>--->
		<script src="agrega_auto2.js"></script>
		...
		function CalculaRegresos(){
			console.log(" pulsaste la prueba: "+agregados);
			for(var i=0, j=1;i<(this).agregados.length;i++,j++){
				if((this).agregados[i]!="libre"){	
					if ($("#reg"+j).is(':checked')) {
			        	//magna
			        	calculaViaje()
			        	console.log(agregados[i]+" regresa");
			        }else{
			        	console.log(agregados[i]+" se queda");
			        }			
				}
			}
			...
			$(document).ready(function(){
				...
				$('.modSi').click(function() {
					//alert("si mod");
					if ($('.modSi').is(':checked')) {
						$('#Rendimiento').removeAttr("readOnly");
					}
				});
				$('.modNo').click(function() {
					//alert("no mod");
					if ($('.modNo').is(':checked')) {

					...
					<div class="mt-1 mb-3 p-3 button-container fondo-container">
						...
						<ol class="breadcrumb fondo-encabezados">
							...
							<li class="active text-white">
								<strong>Monitoreo Entrega y Recepción del VIN</strong>
							</li>
						</ol>
						...
						<div class="row">
							<div class="col-sm-12">
								<form id="form_monitorear_vin" method="POST" >
											...
											<div class="container-bg-1 p-3">
												...
												<div class="row">
													...
													<div class="col-sm-6 form-group">
														...
														<input class="form-control" type="text" id="fecha_inicio" name="fecha_inicio" readonly="" value="<?php echo $fecha_hoy; ?>" />
													</div>

													<div class="col-sm-6 form-group">
														<label>*Fecha de Fin:</label>
														<input class="form-control" type="text" id="fecha_fin" name="fecha_fin" readonly="" value="<?php echo $fecha_hoy; ?>" />
														<br>
													</div>
												</div>
...
<script  type="text/javascript" class="init">
	...
	$(document).ready(function() {
		...
		$("#show_date").click(function(){
			...
			var datos_balance = $("#form_monitorear_vin").serialize();


			$.ajax({
				url : 'show_vin_comparacion.php',
				data : datos_balance,
				type : 'POST',
				beforeSend: function(){
	...
	function buscar_ColaboradorIdLo() {
		...
		if (textoBusquedaColaborador != "") {
			...
			$("#resultadoBusquedaColaboradorID").html('<p><b>No es posible realizar la busqueda con datos incompletos.</b></p>');
		};
	};

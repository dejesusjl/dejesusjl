...
<head>
	...
	<title>CCP | Agregar Colaborador Departamento</title>
				...
				<div class="col-sm-12">
					<div class="mt-1 mb-3 p-3 button-container fondo-container">
						...
						<ol class="breadcrumb fondo-encabezados">
							...
							<li>
								<a class="text-white" href="catalogo_colaborador_departamento.php">Resumen Colaborador Departamento</a>
							</li>
							<span class="text-white"> &nbsp;/&nbsp; </span>
							<li class="text-white" class="active">
								<strong>Agregar Colaborador Departamento</strong>
							</li>
						</ol>
						...
						<form id="form_balance" method="POST" action="catalogo_colaborador_departamento_guardar.php">
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group row">
										...
										<div id="button_principal_orden" class="col-sm-12" >
											<center>
												<a id='create_colaborador_departamento' style='width: 180px;height: 90px;' class="create_colaborador_departamento icon-DOrden" class="" title="Add field"><i class='fa fa-plus-circle fa-5x zoom font-iconr' aria-hidden='true' ></i></a>
												<div class="tooltipDetalleOrden mb-3">
													<p>Agregar Colaborador Departamento</p>
												</div>
											</center>
										...
										<div class="col-sm-12">
											<div class="col-sm-12 field_colaboradordepartamento">
										...
										<input type="hidden" name="contador_colaborador_departamento" value="0" required="" class="contador_colaborador_departamento">
										...
										<script type="text/javascript">
											$(document).ready(function(){
												...
												var addButtonColDep = $('#create_colaborador_departamento');
												var wrapper_vin = $('.field_colaboradordepartamento');
												var valor_vin = 0;

												$(addButtonColDep).click(function(){ 
													valor_vin ++;


													var new_array_col_dep =`
													...
													<?php 
													$query_usuario = "SELECT * FROM usuarios where visible = 'SI' and rol = '101'";
													$result_usuario = mysql_query($query_usuario);

													while ($row_usuario = mysql_fetch_array($result_usuario)) {

														$query_colaborador = "SELECT * FROM empleados WHERE idempleados = '$row_usuario[idempleados]'";
														$result_colaborador = mysql_query($query_colaborador);

														while ($row_empleados = mysql_fetch_array($result_colaborador)) {

															echo "<option value='$row_empleados[idempleados]'>$row_empleados[nombre] $row_empleados[apellido_paterno] $row_empleados[apellido_materno] ($row_empleados[columna_b]) </option>";
													...
													<a class="button-eliminar remove_col_dep mt-4 mb-4">
													...
													$(wrapper_vin).append(new_array_col_dep); 
													$(".contador_colaborador_departamento").val(valor_vin);



													if (valor_vin == 0) {
														$(".contador_colaborador_departamento").val("0");
												...
												$(wrapper_vin).on('click', '.remove_col_dep', function(e){
													valor_vin--; 
													e.preventDefault();

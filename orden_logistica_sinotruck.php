...
<head>
	...
	<title>CCP | Reportes Logística Sinotruck</title>
	<style>
		#show_date{
			cursor: pointer;
		}
				...
				<div class="col-sm-12">
					<div class="mt-1 mb-3 p-3 button-container fondo-container">
						...
						<ol class="breadcrumb fondo-encabezados">
							...
							<li>
								<a class="text-white" href="agregar_orden_logistica.php">Resumen Balance Gastos Sinotruck</a>
							</li>
							<span class="text-white"> &nbsp;/&nbsp; </span>
							<li class="active text-white">
								<strong>Resumen Logística Sinotruck</strong>
							</li>
						</ol>
...
<script  type="text/javascript" class="init">
	...
	$(document).ready(function() {
		...
		$("#show_date").click(function(){
			...
			$.ajax({
				url : 'sinotruck_orden_logistica.php',
				data : datos_balance,
				type : 'POST',
				beforeSend: function(){

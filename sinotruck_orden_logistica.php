...
$query_logisticas_sinotruck = "SELECT * FROM orden_logistica where iddepartamento = '15' and idasigna <> 'N/A' and DATE_FORMAT(fecha_solicitud, '%Y-%m-%d') between '$fecha_a' and '$fecha_b'";

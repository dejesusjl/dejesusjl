...
<head>
	...
	<title>CCP | Combustible Km Utilitarias</title>
	<style>
		#show_date{
			cursor: pointer;
		}
					...
					<div class="mt-1 mb-3 p-3 button-container fondo-container">
						...
						<ol class="breadcrumb fondo-encabezados">
							...
							<li class="active text-white">
								<strong>Resumen Kilometraje | Combustible de Unidades Utilitarias</strong>
							</li>
						</ol>
						...
						<form id="form_km_fuel" method="POST" action="show_table_balance_gastos.php">
							<div class="row">
								<div class="col-sm-12">
													...
													<div>
														...
														<div class="container-checks-1 mt-4">
															...
															<div class="d-flex justify-content-center align-items-center flex-wrap">
																<?php 
																$query_responsable = "SELECT unidades_utilitarios_km.idcolaborador, empleados.columna_b FROM unidades_utilitarios_km INNER JOIN empleados WHERE unidades_utilitarios_km.idcolaborador = empleados.idempleados AND unidades_utilitarios_km.visible = 'SI' GROUP BY idcolaborador order by columna_b ";
																...
																while ($row_responsable = mysql_fetch_array($result_responsable)) {
																	echo "
																	<div class='m-2'>
																	<input onchange='filterme()' type='checkbox' class='filtros' name='filter_responsable' value='$row_responsable[columna_b]'>
																	<span>$row_responsable[columna_b]&nbsp;</span>
																	</div>											
																	";
																}
																?>
														...
														<div class="container-checks-1 mt-4">
															...
															<div class="d-flex justify-content-center align-items-center flex-wrap">
																<?php 
																$query_vin = "SELECT vin FROM unidades_utilitarios_km WHERE visible = 'SI' GROUP BY vin order by vin ";
																...
																while ($row_vin = mysql_fetch_array($result_vin)) {
																	echo "
																	<div class='m-2'>
																	<input onchange='filterme()' type='checkbox' class='filtros' name='filter_vin' value='$row_vin[vin]'>
																	<span>$row_vin[vin]&nbsp;</span>
																	</div>											
																	";
																}
																?>
														...
														<div class="container-checks-1 mt-4">
															...
															<div class="d-flex justify-content-center align-items-center flex-wrap">
																...
																<div class='m-2'>
																	<input onchange='filterme()' type='checkbox' class='filtros' name='filter_type' value='Entrada'>
																	<span>Entrada&nbsp;</span>
																</div>	

																<div class='m-2'>
																	<input onchange='filterme()' type='checkbox' class='filtros' name='filter_type' value='Salida'>
																	<span>Salida&nbsp;</span>
																</div>	
...
<script  type="text/javascript" class="init">
	...
	$(document).ready(function() {
		...
		$("#show_date").click(function(){
			...
			var datos_balance = $("#form_km_fuel").serialize();


			$.ajax({
				url : 'km_fuel_resumen.php',
				data : datos_balance,
				type : 'POST',
				beforeSend: function(){

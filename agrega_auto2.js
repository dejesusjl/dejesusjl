            	 ...
            	 if(!remplazo){
    	        	...
    	        	fieldHTMLVIN = `
    	                            <div class="row" id="vehiculo${add_auto}">
                                        ...
                                        <div class="col-sm-3"> 
                                        <label>Regresa? </label>
                                        <label for="regSi">SI</label>
                                        <input type="radio" class="radio1" name="Reg${add_auto}" id="reg${add_auto}" checked  required="">
                                        <label for="regSi">NO</label>
                                        <input type="radio" class="radio1" name="Reg${add_auto}"  required=""> 
                                              </div>                                    
    	                            </div>`;
...
function caclulaCostos(d,t){
	...
	function cambia(){
		...
		if(r!=kilitros.length){
			...
			document.getElementById("costo").value ="$ " + totalltr.toFixed(2) ; 

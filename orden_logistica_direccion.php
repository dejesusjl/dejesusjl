			...
			<div class="row mt-3 m-0">
				<div class="col-sm-12">
					<div class="mt-1 mb-3 p-3 button-container fondo-container">
						...
						<form id="form_actividades_administrativas" method="POST" action="show_table_balance_gastos.php">
								...
								<div class="col-sm-12">
									<div class="container-bg-1 p-3">
										<div class="row">
											...
											<div class="col-sm-6">
												<label class=fecha_fin"">*Fecha de Fin:</label>
...
<script  type="text/javascript" class="init">
	...
	$(document).ready(function() {
		...
		$("#show_date").click(function(){
			...
			var datos_balance = $("#form_actividades_administrativas").serialize();
			...
			$.ajax({
				url : 'show_table_direccion_actividades administrativas.php',
				data : datos_balance,
				type : 'POST',
				beforeSend: function(){

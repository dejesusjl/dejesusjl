...
if ($fecha_a != "" and $fecha_b == "") {
    ...
    *
	...
	orden_logistica
	WHERE
	trim(idcontacto) = '$idcontacto'
	AND trim(tipo_contacto) = '$tipo_contacto'
    ...
    *
	...
	$query_logistica = "SELECT * FROM orden_logistica WHERE trim(idcontacto) = '$idcontacto' AND trim(tipo_contacto) = '$tipo_contacto'";
...
while ($row_logistica = mysql_fetch_array($result_logistica)) {
	...
	<td><span>$porciones_trasladista[10] ($porciones_trasladista[2])</span></td>
	</tr>
	";

}
#------------------------------------------- Total General Logistica --------------------------------------------------------------------------------
...
AND orden_logistica.idcontacto = '$idcontacto'
AND orden_logistica.tipo_contacto = '$tipo_contacto' $valores
...
AND tipo_contacto = '$tipo_contacto' $valores
...
while ($row_trasladista_count = mysql_fetch_array($result_trasladista_count)) {
	...
	<td><span>$array_trasladista[10] ($array_trasladista[2])</span></td>

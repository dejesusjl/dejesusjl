				...
				<div class="col-sm-12">
					<div class="mt-1 mb-3 p-3 button-container fondo-container">
						...
						<ol class="breadcrumb fondo-encabezados">
							...
							<li>
								<a class="text-white" href="catalogo_rolvin_departamento_resumen.php">Resumen Rol VIN Departamento</a>
							</li>
							<span class="text-white"> &nbsp;/&nbsp; </span>
							<li class="text-white" class="active">
								<strong>Agregar Rol VIN Departamento</strong>
							</li>
						</ol>
						...
						<form id="form_balance" method="POST" action="catalogo_rolvin_departamento_guardar.php">
							<div class="row">
								<div class="col-sm-12">
										...
										<div id="button_principal_orden" class="col-sm-12" >
											<center>
												...
												<div class="tooltipDetalleOrden mb-3">
													<p>Agregar Nuevo Rol de VIN Departamento</p>
												</div>
											</center>
										...
										<script type="text/javascript">
											$(document).ready(function(){
												...
												$(addButtonVIN).click(function(){ 
													...
													<label>*Rol VIN</label>
													<div class="content-select">
													<select name="idrolvin[]" class="form-control">
													<?php 
													$query_rol_vin = "SELECT * FROM orden_logistica_rol_vin where visible = 'SI' order by nombre asc";
													$result_rol_vin = mysql_query($query_rol_vin);

													while ($row_rol_vin = mysql_fetch_array($result_rol_vin)) {
														echo "<option value='$row_rol_vin[idorden_logistica_rol_vin]'>$row_rol_vin[nombre]</option>";
													}
													?>
													</select>
													</div>
